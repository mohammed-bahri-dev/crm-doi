 ...
 */
final class Version20200601101558 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE partner_status ADD name VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE type_of_ca_entity ADD name VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE partner_status DROP name');
        $this->addSql('ALTER TABLE type_of_ca_entity DROP name');
